#!/usr/bin/env python3
"""Deterministic fresh-agent R6 cross-version replay probe for F.RUV.W3Q2.B7."""
...
def run_probe() -> dict[str, Any]:
    ...
    migrated, migration = migrate_record(
        source,
        kind="event",
        target_schema_version=EVENT_SCHEMA_VERSION,
    )
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        deletion = delete_export(
            ...
            effective_at="2026-08-19T08:02:00Z",
        )
    ...
    tombstone = make_tombstone(
        ...
        effective_at="2026-08-19T08:02:00Z",
        source_receipt_ref="receipt:fresh-agent-r6",
    )
    ...
    result = {
        "schema_version": "gva06.f.ruv.w3q2.b7.fresh-agent-r6-probe.v1",
        "artifact_id": "FreshAgentCrossVersionReplayProbe.v1",
        "branch_id": "F.RUV.W3Q2.B7",
        "cases": cases,
